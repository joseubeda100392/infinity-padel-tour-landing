  ...
  return (
    <section className="noise-overlay relative flex min-h-[75vh] flex-col overflow-hidden bg-[#05080F]">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-16 pt-0 text-center">
        ...
        <div className="mb-8 inline-flex items-center gap-3 border border-vibora/25 bg-vibora/[0.07] px-4 py-2">
          ...
          <span className="text-vibora/50">·</span>
        ...
        <Link
          href="#liga-form"
          className="group inline-flex items-center gap-2.5 bg-vibora px-8 py-4 font-anek-label text-[12px] font-bold uppercase tracking-[0.2em] text-[#05080F] transition-all duration-200 hover:brightness-110 active:scale-95"
        >
          {ligaHero.cta}
