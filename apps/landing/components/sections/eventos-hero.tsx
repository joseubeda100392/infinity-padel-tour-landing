  ...
  return (
    <section className="noise-overlay relative flex min-h-[75vh] flex-col overflow-hidden bg-[#05080F]">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-16 pt-0 text-center">
        ...
        {/* Eyebrow */}
        <div className="mb-8 inline-flex items-center gap-2.5 border border-bandeja/30 bg-bandeja/[0.06] px-4 py-2">
        ...
        <Link
          href="#evento-form"
          className="group inline-flex items-center gap-2.5 bg-chiquita px-8 py-4 font-anek-label text-[12px] uppercase tracking-[0.2em] text-white font-bold transition-all duration-200 hover:brightness-110 active:scale-95"
        >
          {eventosHero.cta}
