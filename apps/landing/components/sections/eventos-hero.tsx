  ...
  return (
    <section className="noise-overlay relative flex min-h-[75vh] flex-col overflow-hidden bg-[#05080F]">
      ...
      <div className="relative z-10 flex flex-1 flex-col items-center justify-center px-4 pb-16 pt-0 text-center">
        ...
        <div className="mb-8 inline-flex items-center gap-2.5 border border-chiquita/30 bg-chiquita/[0.07] px-4 py-2">
          <span className="font-anek-label text-[11px] uppercase tracking-[0.3em] text-chiquita">
            {eventosHero.eyebrow}
          </span>
        </div>
        ...
        >
          <span className="block text-white">{eventosHero.headline_line1}</span>
          <span className="block text-chiquita">{eventosHero.headline_line2}</span>
        </h1>

        <p className="mb-10 max-w-lg text-sm leading-relaxed text-white/60 sm:text-base">
          {eventosHero.description}
        </p>

        <Link
          href="#evento-form"
          className="group inline-flex items-center gap-2.5 bg-chiquita px-8 py-4 font-anek-label text-[12px] font-bold uppercase tracking-[0.2em] text-white transition-all duration-200 hover:brightness-110 active:scale-95"
        >
          {eventosHero.cta}
